...
In our development, we created two distinct versions.
...
attacks, but it is not very efficient. Our second implementation used
the generation of an AES-256 session key to encrypt the JSON data
structure, as described earlier in this document.
